...
class biblio_search_rpt extends BiblioRows {
	...
	function biblio_search_rpt() {
		$this->searchTypes = array(
			...
			'author' => Search::type('Author', 'MARC', array('100$a', '245$c')),
			'title' => Search::type('Title', 'MARC', array('245$a', '245$b')),
			'subject' => Search::type('Subject', 'MARC', array('650$a', '651$a')),
			'publisher' => Search::type('Publisher', 'MARC', array('260$b')),
			'address' => Search::type('Address', 'MARC', array('260$a')),
			'date' => Search::type('Date', 'MARC', array('260$c')),
