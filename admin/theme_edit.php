 ...
 */
  ...
  $errors = $themes->update_el($theme);
  if (!empty($errors)) {
    FieldError::backToForm('../admin/theme_edit_form.php', $errors);
  }
  ...
  echo T("Theme, %name%, has been updated.", array('name'=>H($theme['theme_name']))).'<br /><br />';
