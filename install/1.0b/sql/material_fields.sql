...
--
-- Host: localhost
-- Generation Time: Aug 24, 2011 at 10:57 PM
...
(58, 7, '342', 'g', 10, 'Longitude of central meridian or projection center', 'text', 0, 0, NULL),
(37, 6, '245', 'f', 2, 'Inclusive dates', 'text', 0, 0, NULL),
(38, 6, '245', 'h', 3, 'Medium', 'text', 0, 0, NULL),
...
(40, 6, '22', 'a', 9, 'International Standard Serial Number', 'text', 0, 0, NULL),
(41, 6, '50', 'a', 12, 'Classification number', 'text', 0, 0, NULL),
(55, 7, '110', 'a', 5, 'Corporate name or jurisdiction name as entry element', 'text', 0, 0, NULL),
(43, 6, '410', 'a', 0, 'Corporate name or jurisdiction name as entry element', 'text', 0, 0, NULL),
(44, 6, '245', 'a', 1, 'Title', 'text', 0, 0, NULL),
(57, 7, '342', 'd', 8, 'Longitude resolution', 'text', 0, 0, NULL),
(56, 7, '342', 'c', 7, 'Latitude resolution', 'text', 0, 0, NULL),
(50, 6, '50', 'b', 13, 'Item number', 'text', 0, 0, NULL),
(59, 7, '342', 'q', 11, 'Ellipsoid name', 'text', 0, 0, NULL),
(60, 7, '342', 'w', 14, 'Local planar or local georeference information', 'text', 0, 0, NULL),
(61, 7, '342', 'h', 15, 'Latitude of projection origin or projection center', 'text', 0, 0, NULL),
(62, 1, '20', 'a', 0, 'International Standard Book Number', 'text', 0, 0, NULL),
(66, 8, '245', 'h', 3, 'Medium', 'text', 0, 0, NULL),
(67, 8, '306', 'a', 4, 'Playing time', 'text', 0, 0, NULL),
(68, 8, '260', 'c', 5, 'Date of publication, distribution, etc.', 'text', 0, 0, NULL),
(69, 8, '260', 'b', 6, 'Name of publisher, distributor, etc.', 'text', 0, 0, NULL),
(70, 8, '260', 'a', 7, 'Place of publication, distribution, etc.', 'text', 0, 0, NULL),
(74, 8, '650', 'a', 11, 'Topical term or geographic name as entry element', 'text', 0, NULL, NULL);
