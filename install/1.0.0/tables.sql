...
--
-- Host: localhost
-- Generation Time: Jul 26, 2011 at 09:42 AM
...
CREATE TABLE IF NOT EXISTS `biblio_field` (
  ...
  KEY `bibid_idx` (`bibid`),
  KEY `tag_idx` (`tag`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=22029 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=22166 ;
...
--
-- Table structure for table `xbiblio_copy`
--

CREATE TABLE IF NOT EXISTS `xbiblio_copy` (
  `bibid` int(11) NOT NULL default '0',
  `copyid` int(11) NOT NULL auto_increment,
  `create_dt` datetime NOT NULL default '0000-00-00 00:00:00',
  `last_change_dt` datetime NOT NULL default '0000-00-00 00:00:00',
  ...
  KEY `bibid_idx` (`bibid`),
  KEY `barcode_index` (`barcode_nmbr`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9631 ;

-- --------------------------------------------------------

--
-- Table structure for table `xbiblio_copy_fields`
--

CREATE TABLE IF NOT EXISTS `xbiblio_copy_fields` (
  `copyid` int(11) NOT NULL default '0',
  `bibid` int(11) NOT NULL default '0',
  `code` varchar(16) NOT NULL default '',
  `data` text NOT NULL,
